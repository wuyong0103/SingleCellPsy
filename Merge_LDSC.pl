...
system("sed '1d' /home/lilab/wuyong/project/scRNA/integrate/Mean/LDSC/Bed/LDSC_cell_types_GWAS_pvalues.txt | cut -f 1 | sort -u >Disease.txt");
my %ct;
...
while(<IN>){
    ...
    my %exp;
    $header = $header."\t$_";
    my $file = "/home/lilab/wuyong/project/scRNA/integrate/".$_."/LDSC/Bed/LDSC_cell_types_GWAS_pvalues.txt";
