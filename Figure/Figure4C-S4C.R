...
colnames(scz_mean) <- gsub("Mean_SubCellType_Male_", "", colnames(scz_mean))
rownames(scz_ldsc) <- gsub("[A-Za-z0-9]+-","", rownames(scz_ldsc))
colnames(scz_ldsc) <- gsub("Mean_SubCellType_Male_", "", colnames(scz_ldsc))
rownames(scz_magma) <- gsub("[A-Za-z0-9]+-","", rownames(scz_magma))
colnames(scz_magma) <- gsub("Mean_SubCellType_Male_", "", colnames(scz_magma))
...
colnames(bd_mean) <- gsub("Mean_SubCellType_Male_", "", colnames(bd_mean))
rownames(bd_ldsc) <- gsub("[A-Za-z0-9]+-","", rownames(bd_ldsc))
colnames(bd_ldsc) <- gsub("Mean_SubCellType_Male_", "", colnames(bd_ldsc))
rownames(bd_magma) <- gsub("[A-Za-z0-9]+-","", rownames(bd_magma))
colnames(bd_magma) <- gsub("Mean_SubCellType_Male_", "", colnames(bd_magma))
...
colnames(mdd_mean) <- gsub("Mean_SubCellType_Male_", "", colnames(mdd_mean))
rownames(mdd_ldsc) <- gsub("[A-Za-z0-9]+-","", rownames(mdd_ldsc))
colnames(mdd_ldsc) <- gsub("Mean_SubCellType_Male_", "", colnames(mdd_ldsc))
rownames(mdd_magma) <- gsub("[A-Za-z0-9]+-","", rownames(mdd_magma))
colnames(mdd_magma) <- gsub("Mean_SubCellType_Male_", "", colnames(mdd_magma))
...
colnames(int_mean) <- gsub("Mean_SubCellType_Male_", "", colnames(int_mean))
rownames(int_ldsc) <- gsub("[A-Za-z0-9]+-","", rownames(int_ldsc))
colnames(int_ldsc) <- gsub("Mean_SubCellType_Male_", "", colnames(int_ldsc))
rownames(int_magma) <- gsub("[A-Za-z0-9]+-","", rownames(int_magma))
colnames(int_magma) <- gsub("Mean_SubCellType_Male_", "", colnames(int_magma))
...
colnames(ad_mean) <- gsub("Mean_SubCellType_Male_", "", colnames(ad_mean))
rownames(ad_ldsc) <- gsub("[A-Za-z0-9]+-","", rownames(ad_ldsc))
colnames(ad_ldsc) <- gsub("Mean_SubCellType_Male_", "", colnames(ad_ldsc))
rownames(ad_magma) <- gsub("[A-Za-z0-9]+-","", rownames(ad_magma))
colnames(ad_magma) <- gsub("Mean_SubCellType_Male_", "", colnames(ad_magma))
...
colnames(oct_mean) <- gsub("Mean_SubCellType_Male_", "", colnames(oct_mean))
rownames(oct_ldsc) <- gsub("[A-Za-z0-9]+-","", rownames(oct_ldsc))
colnames(oct_ldsc) <- gsub("Mean_SubCellType_Male_", "", colnames(oct_ldsc))
rownames(oct_magma) <- gsub("[A-Za-z0-9]+-","", rownames(oct_magma))
colnames(oct_magma) <- gsub("Mean_SubCellType_Male_", "", colnames(oct_magma))
...
colnames(an_mean) <- gsub("Mean_SubCellType_Male_", "", colnames(an_mean))
rownames(an_ldsc) <- gsub("[A-Za-z0-9]+-","", rownames(an_ldsc))
colnames(an_ldsc) <- gsub("Mean_SubCellType_Male_", "", colnames(an_ldsc))
rownames(an_magma) <- gsub("[A-Za-z0-9]+-","", rownames(an_magma))
colnames(an_magma) <- gsub("Mean_SubCellType_Male_", "", colnames(an_magma))
...
colnames(hs_mean) <- gsub("Mean_SubCellType_Male_", "", colnames(hs_mean))
rownames(hs_ldsc) <- gsub("[A-Za-z0-9]+-","", rownames(hs_ldsc))
colnames(hs_ldsc) <- gsub("Mean_SubCellType_Male_", "", colnames(hs_ldsc))
rownames(hs_magma) <- gsub("[A-Za-z0-9]+-","", rownames(hs_magma))
colnames(hs_magma) <- gsub("Mean_SubCellType_Male_", "", colnames(hs_magma))
...
colnames(ts_mean) <- gsub("Mean_SubCellType_Male_", "", colnames(ts_mean))
rownames(ts_ldsc) <- gsub("[A-Za-z0-9]+-","", rownames(ts_ldsc))
colnames(ts_ldsc) <- gsub("Mean_SubCellType_Male_", "", colnames(ts_ldsc))
rownames(ts_magma) <- gsub("[A-Za-z0-9]+-","", rownames(ts_magma))
colnames(ts_magma) <- gsub("Mean_SubCellType_Male_", "", colnames(ts_magma))
...
colnames(ins_mean) <- gsub("Mean_SubCellType_Male_", "", colnames(ins_mean))
rownames(ins_ldsc) <- gsub("[A-Za-z0-9]+-","", rownames(ins_ldsc))
colnames(ins_ldsc) <- gsub("Mean_SubCellType_Male_", "", colnames(ins_ldsc))
rownames(ins_magma) <- gsub("[A-Za-z0-9]+-","", rownames(ins_magma))
colnames(ins_magma) <- gsub("Mean_SubCellType_Male_", "", colnames(ins_magma))
...
colnames(su_mean) <- gsub("Mean_SubCellType_Male_", "", colnames(su_mean))
rownames(su_ldsc) <- gsub("[A-Za-z0-9]+-","", rownames(su_ldsc))
colnames(su_ldsc) <- gsub("Mean_SubCellType_Male_", "", colnames(su_ldsc))
rownames(su_magma) <- gsub("[A-Za-z0-9]+-","", rownames(su_magma))
colnames(su_magma) <- gsub("Mean_SubCellType_Male_", "", colnames(su_magma))
...
colnames(ed_mean) <- gsub("Mean_SubCellType_Male_", "", colnames(ed_mean))
rownames(ed_ldsc) <- gsub("[A-Za-z0-9]+-","", rownames(ed_ldsc))
colnames(ed_ldsc) <- gsub("Mean_SubCellType_Male_", "", colnames(ed_ldsc))
rownames(ed_magma) <- gsub("[A-Za-z0-9]+-","", rownames(ed_magma))
colnames(ed_magma) <- gsub("Mean_SubCellType_Male_", "", colnames(ed_magma))
...
colnames(adhd_mean) <- gsub("Mean_SubCellType_Male_", "", colnames(adhd_mean))
rownames(adhd_ldsc) <- gsub("[A-Za-z0-9]+-","", rownames(adhd_ldsc))
colnames(adhd_ldsc) <- gsub("Mean_SubCellType_Male_", "", colnames(adhd_ldsc))
rownames(adhd_magma) <- gsub("[A-Za-z0-9]+-","", rownames(adhd_magma))
colnames(adhd_magma) <- gsub("Mean_SubCellType_Male_", "", colnames(adhd_magma))
...
colnames(asd_mean) <- gsub("Mean_SubCellType_Male_", "", colnames(asd_mean))
rownames(asd_ldsc) <- gsub("[A-Za-z0-9]+-","", rownames(asd_ldsc))
colnames(asd_ldsc) <- gsub("Mean_SubCellType_Male_", "", colnames(asd_ldsc))
rownames(asd_magma) <- gsub("[A-Za-z0-9]+-","", rownames(asd_magma))
colnames(asd_magma) <- gsub("Mean_SubCellType_Male_", "", colnames(asd_magma))
